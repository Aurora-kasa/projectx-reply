export const GREETING_KEYWORDS = ['hello', 'hi', 'hey', '你好', '您好'];

export const REPLY_HTML = `
<div style="font-family:Poppins,sans-serif;color:#ffffff;background:linear-gradient(135deg,#667eea 0%,#764ba2 100%);padding:40px;border-radius:12px;max-width:600px;margin:auto">
